...
<html>
  ...
  <!-- HTML code can reside ABOVE and BELOW the starting and closing PHP tags -->
    ...
    $sql= "SELECT e.event_id,e.event_name,e.event_venue,e.event_date,e.event_time,e.event_manager_num FROM events e
    ...
    $result = mysqli_query($db_server, $sql);
      ...
      echo "<br><br>";
            ...
            echo "Currently you are not participating in any of the events";
